# 1 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
# 1 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/build_out/bl602_boot2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
# 31 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
...
# 32 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c" 2
...
# 33 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c" 2
...
# 34 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c" 2
...
# 35 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c" 2
...
# 37 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c" 2
...
uint32_t BLSP_Boot2_Get_Baudrate(void);
uint8_t BLSP_Boot2_Get_TX_GPIO(void);
# 38 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c" 2
...
# 39 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c" 2
# 69 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
...
# 99 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
void BLSP_Dump_Data(void *datain,int len)
{
    int i=0;
...
# 121 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
int32_t BLSP_MediaBoot_Pre_Jump(void)
{
...
# 143 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
...
# 173 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
void __attribute__((section(".tcm_code"))) BLSP_Boot2_Jump_Entry(void)
{
    pentry_t pentry;
    uint32_t i=0;
    int32_t ret;
...
# 209 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
            }
        }
    ...
    for(i=1;i<cpuCount;i++){
        if(bootImgCfg[i].imgValid){
            ((*(volatile uint32_t*)(bootCpuCfg[i].mspStoreAddr))=(bootImgCfg[i].mspVal));
            ((*(volatile uint32_t*)(bootCpuCfg[i].pcStoreAddr))=(bootImgCfg[i].entryPoint));
        }else{
            ((*(volatile uint32_t*)(bootCpuCfg[i].mspStoreAddr))=(0));
            ((*(volatile uint32_t*)(bootCpuCfg[i].pcStoreAddr))=(0));
        }
    ...
    if(bootImgCfg[0].imgValid){
        ...
        if(bootImgCfg[0].mspVal!=0){
            __asm volatile ("add sp, x0, %0":: "r"(bootImgCfg[0].mspVal));
        }
        ...
        if(pentry!=
# 244 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c" 3 4
                  ((void *)0)
# 244 "/home/ubuntu/dev/bl_iot_sdk/examples/bl602_boot2/bl602_boot2/blsp_common.c"
                      ){
            pentry();
        }
    }
